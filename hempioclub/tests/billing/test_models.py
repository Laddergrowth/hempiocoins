...
class TestCoupon(object):
    def test_random_coupon_code(self):
        ...
        from hempioclub.blueprints.billing.tasks import expire_old_coupons
...
class TestInvoice(object):
    ...
    def test_invoice_create(self, users, mock_stripe):
        ...
        invoice = Invoice()
        invoice.create(user=user, currency='usd', amount='900', hccoins=1000,
                       coupon=None, token='cus_000')

        assert user.hccoins == 1100
