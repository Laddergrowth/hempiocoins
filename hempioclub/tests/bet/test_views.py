...
class TestBetting(ViewTestMixin):
    ...
    def test_bet_create_fails_due_to_not_enough_hccoins(self):
        """ Bet create fails due to not enough hccoins. """
        self.login()
        ...
        assert 'You cannot wager more than your total hccoins.' in data['error']
