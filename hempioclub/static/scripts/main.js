...
var bets = function () {
  ...
  var placeBet = function (csrfToken) {
    return $.ajax({
      ...
      var dice_entities = '';
      var status_class = '';
      var hccoinsLeft = parseInt($userCoins.text());

      $userCoins.text(hccoinsLeft + parsed_data.net);
      ...
      var status_class = 'alert-error';
      var error_status = 'You are out of hccoins. You should buy more.';
