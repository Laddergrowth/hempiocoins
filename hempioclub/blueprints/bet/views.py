...
from hempioclub.extensions import limiter
from hempioclub.blueprints.bet.decorators import hccoins_required
from hempioclub.blueprints.bet.forms import BetForm
...
def place_bet():
    ...
    if form.validate_on_submit():
        ...
        if wagered > current_user.hccoins:
            error = 'You cannot wager more than your total hccoins.'
