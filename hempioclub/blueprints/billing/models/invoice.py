...
from hempioclub.extensions import db
from hempioclub.blueprints.billing.models.credit_card import CreditCard
from hempioclub.blueprints.billing.models.coupon import Coupon
from hempioclub.blueprints.billing.gateways.stripecom import (
...
class Invoice(ResourceMixin, db.Model):
    ...
    def create(self, user=None, currency=None, amount=None, hccoins=None,
        ...
        :type amount: int
        :param hccoins: Amount of hccoins
        :type hccoins: int
        ...
        # Add the hccoins to the user.
        user.hccoins += hccoins
