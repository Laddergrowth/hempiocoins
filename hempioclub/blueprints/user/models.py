...
class User(UserMixin, ResourceMixin, db.Model):
    ...
    # Bet.
    hccoins = db.Column(db.BigInteger())
    ...
    def initialize_password_reset(cls, identity):
        ...
        from hempioclub.blueprints.user.tasks import (
    ...
    def add_hccoins(self, plan):
        """
        Add an amount of hccoins to an existing user.

        :param plan: Subscription plan
        :type plan: str
        :return: SQLAlchemy commit results
        """
        self.hccoins += plan['metadata']['hccoins']
