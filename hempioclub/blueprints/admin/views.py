...
from hempioclub.blueprints.admin.models import Dashboard
from hempioclub.blueprints.user.decorators import role_required
from hempioclub.blueprints.billing.decorators import handle_stripe_exceptions
...
from hempioclub.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm,
...
def users_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        from hempioclub.blueprints.billing.tasks import delete_users
...
def coupons_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        # Prevent circular imports.
        from hempioclub.blueprints.billing.tasks import delete_coupons
