...
from hempioclub.blueprints.admin import admin
from hempioclub.blueprints.page import page
from hempioclub.blueprints.contact import contact
from hempioclub.blueprints.user import user
from hempioclub.blueprints.billing import billing
from hempioclub.blueprints.billing import stripe_webhook
from hempioclub.blueprints.bet import bet
from hempioclub.blueprints.user.models import User
from hempioclub.blueprints.billing.template_processors import (
  format_currency,
  current_year
)
from hempioclub.extensions import (
    debug_toolbar,
    mail,
    csrf,
    db,
...
CELERY_TASK_LIST = [
    'hempioclub.blueprints.contact.tasks',
    'hempioclub.blueprints.user.tasks',
    'hempioclub.blueprints.billing.tasks',
]
